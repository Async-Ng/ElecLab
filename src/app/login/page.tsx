      ...
      <div className="w-full h-full bg-white shadow-none overflow-hidden flex transition duration-500">
        <Row gutter={[0, 0]} className="w-full h-full">
          ...
          <Col
            xs={0}
            md={12}
            className="relative bg-gradient-to-br from-indigo-500 to-blue-700 p-10 flex flex-col justify-center items-center text-white"
          >
            <div className="text-center">
              ...
              <Text className="text-white/80 text-lg">
                Hệ thống quản lý vật tư và thiết bị phòng thí nghiệm điện tử của
                bạn.
              </Text>
            </div>
            {/* Vị trí cho hình minh họa lớn */}
            <div className="mt-8">
              <Image
