...
export async function GET(
  ...
  try {
    ...
    const isOwnRequest = request.requester._id.toString() === auth.userId;
...
export async function DELETE(
  ...
  try {
    ...
    if (request.requester.toString() !== auth.userId) {
      return NextResponse.json(
    ...
    await MaterialRequest.findByIdAndDelete(params.id);
